...
export function Result({ successRate, cycles }: ResultProps) {
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12">
          ...
          <div className="w-full lg:w-3/4 relative md:top-[9rem]">
            <div className="relative">
              ...
              {/* <div className="absolute inset-0 bg-gradient-to-r from-transparent to-green-500/30 rounded-lg md:scale-[1.3]" /> */}
              <div className="absolute inset-0 rounded-full bg-radial-gradient from-green-800 via-transparent to-transparent scale-[1.5] md:scale-[2] "></div>              
